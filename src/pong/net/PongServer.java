...
/**
 * A class that represents a Pong server that communicates
 * with the Pong client to be able to transfer and updating
 * the high score list. Uses sockets to communicate.
 * @author Group 4
 * @version 1.0
 * @since 2012-02-19
 */
