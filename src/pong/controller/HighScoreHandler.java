...
/**
 * A class that is used for getting the high score list from
 * a server and updating the high score if any new players
 * beat the previous scores.
 * @author Grupp 4
 * @version 1.0
 * @since 2012-01-27
 */
public class HighScoreHandler 
{
	...
	/**
	 * Resets the high score by creating a new list
	 * and filling it with default scores.
	 */
	...
	/**
	 * Uses the client to communicate to the server
	 * to write new high scores.
	 */
	...
	/**
	 * Reads the high score list from the server
	 * through the client.
	 */
