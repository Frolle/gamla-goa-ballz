...
/** 
* This is a JPanel that displays the current score of the players
* during the game. It contains various methods used for creating
* a panel on the game plan that contains player's names with
* corresponding score.
* @author Group 4
* @version 4.0
* @since 2012-02-22
