...
/**
 * This is a JPanel that is used for displaying the high score list to the
 * players. The high score is supplied by the HighScoreHandler then has a method
 * for displaying the high score list in a table.
 * @author Grupp 4
 * @version 1.0
 * @since 2012-01-27
 */
public class HighScorePanel extends JPanel {
	...
	private void makeTable()
	{
		...
		String[] col = {"Place", "Player", "Points"};
